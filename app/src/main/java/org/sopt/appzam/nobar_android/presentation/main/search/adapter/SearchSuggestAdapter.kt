...
class SearchSuggestAdapter():ListAdapter<RecommendModel, SearchSuggestAdapter.SearchSuggetViewHolder>(SearchSuggestComparator()) {

    class SearchSuggetViewHolder(private val binding : ItemSearchSuggestBinding) : RecyclerView.ViewHolder(binding.root){
